...
using SusuCircle.Api.Features.Circles.UpdateCircle;
using SusuCircle.Api.Features.Collections.BackfillCollectionAccounts;
using SusuCircle.Api.Features.Collections.DisburseFromCollection;
using SusuCircle.Api.Features.Collections.ListCollectionAccounts;
using SusuCircle.Api.Features.Collections.ListMemberAccounts;
using SusuCircle.Api.Features.Collections.SweepContributions;
...
UpdateCircleEndpoint.Map(app);
SweepContributionsEndpoint.Map(app);
ListCollectionAccountsEndpoint.Map(app);
ListMemberAccountsEndpoint.Map(app);
DisburseFromCollectionEndpoint.Map(app);
BackfillCircleCollectionAccountEndpoint.Map(app);
BackfillAllCollectionAccountsEndpoint.Map(app);
